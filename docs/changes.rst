...
*   The new pipeline dedicated to EEG modality has been integrated into the BIDS App
    and `cmpbidsappmanager`. EEG pipeline configuration files are passed to the BIDS
    ...
    `cmpbidsappmanager` and the command to run the BIDS has been updated.
...
*   Major refactoring of all the code related to the EEG pipeline
    ...
    *   Refactoring inputs/outputs of all interface in `cmtklib.eeg`,
        `cmtklib.interfaces.mne`, and `cmtklib.interfaces.pycartool`
