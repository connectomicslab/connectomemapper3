        ...
        Group(
            ...
            Group(
                ...
                Group(Item('run_dmri_pipeline', label='Run processing stages'),
                      Item('dmri_config', label='Configuration file', visible_when='run_dmri_pipeline'),
                      label='Diffusion pipeline'),
                Group(Item('run_fmri_pipeline', label='Run processing stages'),
                      Item('fmri_config', label='Configuration file', visible_when='run_fmri_pipeline'),
                      label='fMRI pipeline'),
        ...
        if self.datalad_is_available and self.data_provenance_tracking:
            ...
            if add_container:
                ...
                try:
                    ...
                    print("   DATALAD ERROR: Failed to link the container image to the dataset")
            ...
            try:
                ...
                print("    DATALAD ERROR: Failed to get files (cmd: datalad get {})".format(" ".join(datalad_get_list)))
        ...
        while not valid_selected_subject and not aborded:
            ...
            if len(sessions) > 0:
                ...
                self.project_info.anat_config_file = os.path.join(self.project_info.base_directory, 'derivatives',
                                                                  'cmp', '{}'.format(self.project_info.subject),
