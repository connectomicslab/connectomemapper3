...
class DiffusionPipeline(Pipeline):
    ...
    def create_pipeline_flow(self,cmp_deriv_subject_directory,nipype_deriv_subject_directory):
        ...
        if self.stages['Diffusion'].config.tracking_processing_tool == 'Custom':
            sinker.inputs.substitutions = [ #('T1', self.subject+'_T1w_head'),
                                            ...
                                            (self.subject+'_label-'+bids_atlas_label+'_desc-scale1_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-'+bids_atlas_label+'_desc-scale1_atlas.nii.gz'),
                                            (self.subject+'_label-'+bids_atlas_label+'_desc-scale2_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-'+bids_atlas_label+'_desc-scale2_atlas.nii.gz'),
                                            (self.subject+'_label-'+bids_atlas_label+'_desc-scale3_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-'+bids_atlas_label+'_desc-scale3_atlas.nii.gz'),
                                            (self.subject+'_label-'+bids_atlas_label+'_desc-scale4_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-'+bids_atlas_label+'_desc-scale4_atlas.nii.gz'),
                                            (self.subject+'_label-'+bids_atlas_label+'_desc-scale5_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-'+bids_atlas_label+'_desc-scale5_atlas.nii.gz'),
                                            ...
                                            (self.subject+'_label-L2008_desc-scale1_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-L2008_desc-scale1_atlas.nii.gz'),
                                            (self.subject+'_label-L2008_desc-scale2_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-L2008_desc-scale2_atlas.nii.gz'),
                                            (self.subject+'_label-L2008_desc-scale3_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-L2008_desc-scale3_atlas.nii.gz'),
                                            (self.subject+'_label-L2008_desc-scale4_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-L2008_desc-scale4_atlas.nii.gz'),
                                            (self.subject+'_label-L2008_desc-scale5_atlas_out_warped.nii.gz',self.subject+'_space-DWI_label-L2008_desc-scale5_atlas.nii.gz'),
    ...
    def process(self):
        ...
        config.update_config({'logging': {'log_directory': os.path.join(nipype_deriv_subject_directory,"diffusion_pipeline"),
                                  'log_to_file': True},
