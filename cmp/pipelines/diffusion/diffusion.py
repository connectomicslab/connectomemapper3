    ...
    def create_pipeline_flow(
        ...
        if self.stages["Diffusion"].config.tracking_processing_tool == "Custom":
            sinker.inputs.substitutions = [  # ('T1', self.subject+'_T1w_head'),
                ...
                (
                    "fast__pve_0_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-CSF_probseg.nii.gz",
                ),
                (
                    "fast__pve_1_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-GM_probseg.nii.gz",
                ),
                (
                    "fast__pve_2_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-WM_probseg.nii.gz",
                ),
                (
                    "pve_0_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-CSF_probseg.nii.gz",
                ),
                (
                    "pve_1_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-GM_probseg.nii.gz",
                ),
                (
                    "pve_2_out_warped.nii.gz",
                    self.subject + "_space-DWI_label-WM_probseg.nii.gz",
                ),
                (
                    "act_5tt_resampled_warped.nii.gz",
                    self.subject + "_space-DWI_label-5TT_probseg.nii.gz",
                ),
                (
                    "gmwmi_resampled_warped.nii.gz",
                    self.subject + "_space-DWI_label-GMWMI_probseg.nii.gz",
                ),
                (
                ...
                (
                    ...
                    self.subject + "_desc-eddycorrected_dwi.nii.gz",
                ),
                (
                ...
                (
                    "streamline_final",
                    "{}_model-{}_desc-{}_tractogram".format(
                        self.subject, recon_model, tracking_model
                    ),
                ),
            ]
        ...
        if self.stages["Registration"].enabled:
            ...
            if (
                self.stages["Registration"].config.registration_mode
                == "BBregister (FS)"
            ):
                diffusion_flow.connect(
                    [
            ...
            diffusion_flow.connect(
                [
                    ...
                    (
                        ...
                        [
                            (
                                "outputnode.brain_mask_registered_crop",
                                "inputnode.brain_mask_registered",
                            )
                        ],
                    ),
                    (
                        ...
                        [
                            (
                                "outputnode.partial_volumes_registered_crop",
                                "inputnode.partial_volumes",
                            )
                        ],
                    ),
                    (
                    ...
                    (
                        ...
                        [
                            (
                                "outputnode.act_5tt_registered_crop",
                                "inputnode.act_5tt_registered",
                            )
                        ],
                    ),
                    (
                        ...
                        [
                            (
                                "outputnode.gmwmi_registered_crop",
                                "inputnode.gmwmi_registered",
                            )
                        ],
                    ),
                    ...
                    (
                        ...
                        [
                            (
                                "outputnode.target_epicorrected",
