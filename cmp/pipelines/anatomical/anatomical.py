...
class AnatomicalPipeline(cmp_common.Pipeline):
    ...
    def process(self):
        ...
        # Initialization
        if os.path.isfile(os.path.join(nipype_deriv_subject_directory,"anat","pypeline.log")):
            os.unlink(os.path.join(nipype_deriv_subject_directory,"anat","pypeline.log"))
        config.update_config({'logging': {'log_directory': os.path.join(nipype_deriv_subject_directory,"anat"),
                                  'log_to_file': True},
