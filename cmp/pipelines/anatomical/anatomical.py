    ...
    def create_pipeline_flow(self, cmp_deriv_subject_directory, nipype_deriv_subject_directory):
        ...
        if self.parcellation_scheme == 'Lausanne2008':
            sinker.inputs.substitutions = [ ('T1.nii.gz', self.subject+'_desc-head_T1w.nii.gz'),
                                        ...
                                        ('ROIv_Lausanne2008_scale2.nii.gz',self.subject+'_label-L2008_desc-scale2_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale3.nii.gz',self.subject+'_label-L2008_desc-scale3_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale4.nii.gz',self.subject+'_label-L2008_desc-scale4_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale5.nii.gz',self.subject+'_label-L2008_desc-scale5_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale1_final.nii.gz',self.subject+'_label-L2008_desc-scale1_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale2_final.nii.gz',self.subject+'_label-L2008_desc-scale2_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale3_final.nii.gz',self.subject+'_label-L2008_desc-scale3_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale4_final.nii.gz',self.subject+'_label-L2008_desc-scale4_atlas.nii.gz'),
                                        ('ROIv_Lausanne2008_scale5_final.nii.gz',self.subject+'_label-L2008_desc-scale5_atlas.nii.gz'),
                                        ('resolution83.graphml',self.subject+'_label-L2008_desc-scale1_atlas.graphml'),
                                        ('resolution150.graphml',self.subject+'_label-L2008_desc-scale2_atlas.graphml'),
                                        ('resolution258.graphml',self.subject+'_label-L2008_desc-scale3_atlas.graphml'),
                                        ('resolution500.graphml',self.subject+'_label-L2008_desc-scale4_atlas.graphml'),
                                        ('resolution1015.graphml',self.subject+'_label-L2008_desc-scale5_atlas.graphml'),
                                        ('resolution83_LUT.txt',self.subject+'_label-L2008_desc-scale1_atlas_FreeSurferColorLUT.txt'),
                                        ('resolution150_LUT.txt',self.subject+'_label-L2008_desc-scale2_atlas_FreeSurferColorLUT.txt'),
            ...
            sinker.inputs.substitutions = [ ('T1.nii.gz', self.subject+'_desc-head_T1w.nii.gz'),
                                        ...
                                        ('aparc+aseg.native.nii.gz',self.subject+'_desc-aparcaseg_dseg.nii.gz'),
                                        ('aparc+aseg.Lausanne2018.native.nii.gz',self.subject+'_desc-aparcaseg_dseg.nii.gz'),
                                        ('ROIv_Lausanne2018_scale1.nii.gz',self.subject+'_label-L2018_desc-scale1_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale2.nii.gz',self.subject+'_label-L2018_desc-scale2_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale3.nii.gz',self.subject+'_label-L2018_desc-scale3_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale4.nii.gz',self.subject+'_label-L2018_desc-scale4_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale5.nii.gz',self.subject+'_label-L2018_desc-scale5_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale1_final.nii.gz',self.subject+'_label-L2018_desc-scale1_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale2_final.nii.gz',self.subject+'_label-L2018_desc-scale2_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale3_final.nii.gz',self.subject+'_label-L2018_desc-scale3_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale4_final.nii.gz',self.subject+'_label-L2018_desc-scale4_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale5_final.nii.gz',self.subject+'_label-L2018_desc-scale5_atlas.nii.gz'),
                                        ('ROIv_Lausanne2018_scale1.graphml',self.subject+'_label-L2018_desc-scale1_atlas.graphml'),
                                        ('ROIv_Lausanne2018_scale2.graphml',self.subject+'_label-L2018_desc-scale2_atlas.graphml'),
                                        ('ROIv_Lausanne2018_scale3.graphml',self.subject+'_label-L2018_desc-scale3_atlas.graphml'),
                                        ('ROIv_Lausanne2018_scale4.graphml',self.subject+'_label-L2018_desc-scale4_atlas.graphml'),
                                        ('ROIv_Lausanne2018_scale5.graphml',self.subject+'_label-L2018_desc-scale5_atlas.graphml'),
                                        ('ROIv_Lausanne2018_scale1_FreeSurferColorLUT.txt',self.subject+'_label-L2018_desc-scale1_atlas_FreeSurferColorLUT.txt'),
                                        ('ROIv_Lausanne2018_scale2_FreeSurferColorLUT.txt',self.subject+'_label-L2018_desc-scale2_atlas_FreeSurferColorLUT.txt'),
                                        ('ROIv_Lausanne2018_scale3_FreeSurferColorLUT.txt',self.subject+'_label-L2018_desc-scale3_atlas_FreeSurferColorLUT.txt'),
                                        ('ROIv_Lausanne2018_scale4_FreeSurferColorLUT.txt',self.subject+'_label-L2018_desc-scale4_atlas_FreeSurferColorLUT.txt'),
                                        ('ROIv_Lausanne2018_scale5_FreeSurferColorLUT.txt',self.subject+'_label-L2018_desc-scale5_atlas_FreeSurferColorLUT.txt'),
            ...
            sinker.inputs.substitutions = [ ('T1.nii.gz', self.subject+'_desc-head_T1w.nii.gz'),
                                        ...
                                        ('freesurferaparc.graphml',self.subject+'_label-Desikan_atlas.graphml'),
                                        ('FreeSurferColorLUT_adapted.txt',self.subject+'_label-Desikan_FreeSurferColorLUT.txt'),
                                      ]
        # else:
