...
def test_parcellate_hippocampal_subfields(subjects_dir,subject_id,base_dir):
    ...
    parcellate_hipposubfields = Node(interface=ParcellateHippocampalSubfields(), name='parcellate_hipposubfield',base_dir=base_dir)
...
def test_parcellate(subjects_dir,subject_id,parcellation_scheme,base_dir):
    ...
    parcellate = Node(interface=Parcellate(),name='parcellate',base_dir=base_dir)
...
def test_parcellate_thalamus(subjects_dir,subject_id,subject_T1w,template,thalamic_maps,base_dir):
    ...
    parcellate_thalamus = Node(interface=ParcellateThalamus(),name='parcellate_thalamus',base_dir=base_dir)
